...
export const UMMAH_PILLARS = [
  ...
  { id: 'moontrance-land',      label: 'Moontrance Land',      Icon: Mountain, route: '/app/moontrance-land'      },
  { id: 'moontrance-seasonal',  label: 'Moontrance Seasonal',  Icon: Leaf,     route: '/app/moontrance-seasonal'  },
  { id: 'moontrance-residency', label: 'Moontrance Residency', Icon: Building, route: '/app/moontrance-residency' },
];
