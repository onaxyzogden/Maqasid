...
export const AMANAH_TIERS = [
  {
    ...
    label: 'Bayyinah',
    arabic: 'بَيِّنَة',
    description: 'Clear proof — named evidence, primary source, or documented pattern. You can act on this.',
    color: '#22c55e',
    bg: '#22c55e18',
  },
  {
    ...
    label: 'Qarina',
    arabic: 'قَرِينَة',
    description: 'Contextual indication — inferred, estimated, or user-provided. Act on it — knowing what it rests on.',
    color: '#f59e0b',
    bg: '#f59e0b18',
  },
  {
    ...
    label: 'Niyyah',
    arabic: 'نِيَّة',
    description: 'Declared intention — aspiration, stated but not yet evidenced. Not something to act on yet.',
    color: '#8b5cf6',
    bg: '#8b5cf618',
  },
];
