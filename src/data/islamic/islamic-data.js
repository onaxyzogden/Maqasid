...
export const MODULE_ATTRS = {
  ...
  'faith-salah': {
    ...
    deferDua: {
      ...
      trans: "Rabbi ajʿalnī muqīma aṣ-ṣalāti wa min dhurriyyatī, Rabbanā wa taqabbal duʿāʾ",
    ...
    pauseWarning: {
      ...
      trans: "Fa-khalafa min ba'dihim khalfun ada'us-salata wattaba'ush-shahawati fa-sawfa yalqawna ghayya",
      meaning: 'But there came after them successors who neglected prayer and pursued desires — they are going to meet ruin.',
      source: 'Surah Maryam 19:59',
    },
    pauseRiseNow: {
      arabic: 'وَسَارِعُوا إِلَىٰ مَغْفِرَةٍ مِّن رَّبِّكُمْ',
      trans: "Wa sari'oo ila maghfiratim-mir-rabbikum",
      meaning: 'And hasten to forgiveness from your Lord.',
      source: "Surah Ali 'Imran 3:133",
    },
    readiness: {
      frame: 'What am I bringing into this prayer?',
      ...
      rows: [
        {
          ...
          attrFrame: 'What am I bringing to the moment before takbir?',
          yesLabel: 'I am bringing',
          notYetLabel: 'I am carrying',
          governing: 'I am bringing a moment of stillness before takbir — remembering who I stand before.',
          notYet: 'I am carrying the momentum of the task I just stepped away from into the niyyah.',
        },
        {
          id: 'Q2', attr: 'Al-Qarib',
          governing: "I am bringing my full attention — the day's concerns set down for the duration of the prayer.",
          notYet: 'I am carrying an unsolved problem with me, still working it while my body is in the prayer.',
        },
        {
          ...
          yesLabel: 'I am bringing',
          notYetLabel: 'I am carrying',
          governing: 'I am bringing something I actually want to ask for — not a slot to check off.',
          notYet: 'I am carrying salah as an item on the calendar, to be completed and returned from.',
        },
        {
          id: 'M2', attr: 'Al-Mujib',
          governing: 'I am bringing the expectation that He hears — shaping my words, tone, and attention accordingly.',
          notYet: 'I am carrying a quiet doubt that the line is live — mouthing the words without expecting a response.',
        },
      ],
      governing: [
        'I am bringing a moment of stillness before takbir — remembering who I stand before.',
        "I am bringing my full attention — the day's concerns set down for the duration of the prayer.",
        'I am bringing something I actually want to ask for — not a slot to check off.',
        'I am bringing the expectation that He hears — shaping my words, tone, and attention accordingly.',
      ],
      notYet: [
        'I am carrying the momentum of the task I just stepped away from into the niyyah.',
        'I am carrying an unsolved problem with me, still working it while my body is in the prayer.',
        'I am carrying salah as an item on the calendar, to be completed and returned from.',
        'I am carrying a quiet doubt that the line is live — mouthing the words without expecting a response.',
      ],
    },
    reflection: {
