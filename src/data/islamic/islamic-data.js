    ...
    attrs: [
      {
        ...
        name_ar: 'الودود',
        title: 'The Loving',
        body: 'Al-Wadūd is love expressed as active care for those placed near you — not the neighbor you chose, but the neighbor Allah placed at your door. The Prophet ﷺ said Jibrīl kept enjoining care for the neighbor until he thought the neighbor would be made an heir. Its absence shows as the ordinary hardness that lets a family on the other side of a wall become invisible — unknown names, unoffered food, unheard trouble.',
      },
      {
        name: 'Al-Muḥsin',
        name_ar: 'المحسن',
        title: 'The Benevolent',
        body: 'Al-Muḥsin is iḥsān directed outward — doing good without counting, without the neighbor needing to ask. Iḥsān in neighbor-right is to anticipate need rather than respond only when pressed. Its absence is the minimum-standard politeness that fulfills no ḥaqq (right) — civility without care, presence without attention.',
      },
    ],
    dua: {
    ...
    attrs: [
      {
        ...
        name_ar: 'الجامع',
        title: 'The Gatherer',
        body: 'Al-Jāmiʿ gathers what is scattered toward a shared center. At the community level — beyond the household, beyond the neighbor — this name asks whether the operator\u2019s presence builds or disperses the wider jamāʿah. Its absence is the quiet drift into faction: personal preference becomes party, difference hardens into camp, and the shared center is abandoned in the name of identity.',
      },
      {
        name: 'Al-Walī',
        name_ar: 'الولي',
        title: 'The Protecting Friend',
        body: 'Al-Walī is the covenant-bound protector — the one who shows up for those bound to him by walāʾ (loyalty). Al-Walī in community life is the refusal to let the collective be a vehicle for personal brand while its weakest members go unprotected. Its absence is the community that performs unity in public while leaving the grieving, the sick, and the new unattended in private.',
      },
    ],
    dua: {
    ...
    attrs: [
      {
        ...
        name_ar: 'الخالق',
        title: 'The Creator',
        body: 'Al-Khāliq originated the earth with purpose — every soil horizon, watershed, and seed-line is the outcome of His creative command. To engage Moontrance land is to stand on māddah (matter) He made and placed in your hand as amānah, not as property. Its absence shows as treating land as inert inventory — acreage to be scraped, leveled, or traded — rather than a living āyah with its own disposition.',
      },
      {
        name: 'Al-Bāriʾ',
        name_ar: 'البارئ',
        title: 'The Shaper',
        body: 'Al-Bāriʾ shapes what is created with precise differentiation — nothing is left crude. Under Al-Bāriʾ, the land steward refuses to overwrite what Allah has already shaped; regenerative practice is a return to His design, not imposition on it. Its absence is the violence of extraction that flattens the site\u2019s native intelligence in favor of a business case that fits a spreadsheet.',
      },
    ],
    dua: {
    ...
    attrs: [
      {
        ...
        name_ar: 'المحيي',
        title: 'The Giver of Life',
        body: 'Al-Muḥyī gives life through water, light, and the breathing earth. Every drop of water you use today was life He extended. To consume resources under Al-Muḥyī is to remember that the tap, the switch, and the field are thin interfaces over a miracle — not infinite, not owed. Its absence shows as unreflective consumption that takes as if it were owed.',
      },
      {
        name: 'Al-Badīʿ',
        name_ar: 'البديع',
    ...
    attrs: [
      {
        ...
        body: 'Al-Quddūs is absolutely pure — and the earth He entrusted is meant to remain fit to live on. To manage waste under Al-Quddūs is to refuse to dump your impurity into what is held in common. Its absence shows in the casual pollution of air, water, and soil by those who treat the commons as a sink for their private convenience.',
      },
      {
        name: 'Aṭ-Ṭāhir',
        name_ar: 'الطاهر',
        title: 'The Pure One',
        body: 'Aṭ-Ṭāhir describes purity extended into what Aṭ-Ṭāhir touches. The believer is commanded to leave a place cleaner than they found it — "an-naẓāfatu min al-īmān." Its absence is the mess left behind, the wrapper dropped, the byproduct externalized, the litter that says "someone else will clean this."',
      },
    ],
    dua: {
    ...
    attrs: [
      {
        ...
        name_ar: 'الحفيظ',
        title: 'The Preserver',
        body: 'Al-Ḥafīẓ preserves. To approach the living world under Al-Ḥafīẓ is to understand that the biodiversity of a forest, the fertility of a soil, the integrity of a watershed are all entrusted — your diligence is one of the means by which He preserves what He has decreed to preserve. Its absence shows as passive complicity in what is being lost.',
      },
      {
        name: 'Ar-Raqīb',
        name_ar: 'الرقيب',
        title: 'The Watchful',
        body: 'Ar-Raqīb watches over all things. Nothing done to creation passes Him unnoticed — not the felled tree, not the wasted field, not the species extinguished. To act toward ecosystems under Ar-Raqīb is to act as if you were already being watched, because you are. Its absence is the behavior people change when they believe no one is looking.',
      },
    ],
    dua: {
    ...
    attrs: [
      {
        ...
        name_ar: 'العليم',
        title: 'The All-Knowing',
        body: 'Al-ʿAlīm knows the entire chain — the hand that mined, the field that grew, the river that was diverted. To source under Al-ʿAlīm is to refuse the comfort of ignorance about where things come from. Its absence shows as deliberate blindness to upstream ethics, the "I didn\'t know" stance maintained by refusing to ask.',
      },
      {
        name: 'Ar-Rashīd',
        name_ar: 'الرشيد',
        title: 'The Guide to Right Conduct',
        body: 'Ar-Rashīd guides toward rushd — mature, right, integrated action. Sourcing under Ar-Rashīd chooses the fitting path between extremes: neither pious withdrawal from all commerce, nor cynical participation in whatever system is cheapest. Its absence is the paralysis that does nothing because nothing is perfect, or the compromise that does anything because everything is broken.',
      },
    ],
    dua: {
