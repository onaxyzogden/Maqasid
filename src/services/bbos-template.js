...
export function generateTaskTemplate(taskDef) {
  ...
  return {
    ...
    fields,
    g_label: null,
    instructions: 'Fill in each field with your data. Re-upload this file into MIOS to populate the task.',
  };
}
...
export function generateStageBundleTemplate(stageId, stageDefs, existingTasks = []) {
  return {
    ...
    instructions: 'Fill in the fields for each task in this bundle, then re-upload into MIOS to populate all stage tasks at once.',
  };
}
