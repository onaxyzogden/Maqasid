...
// STAGE_SCORE_SIGNALS + countNonEmpty + scoreStage + DEV validation moved to
// data/bbos/bbos-stage-score.js (shared with the redesigned pipeline-dashboard
// adapter). Imported above.
...
function StageScoreCard({ bbosFilter, taskMap }) {
  const result = scoreStage(bbosFilter, taskMap);
  if (!result) return null;

  const { totalPts, maxPts, pct, verdict, signals: scored } = result;
  const verdictColor = {
