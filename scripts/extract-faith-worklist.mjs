// Extract Faith pillar review worklist:
...
const lines = [];
lines.push("# Faith Pillar — Launch-Readiness Review Worklist");
lines.push("");
...
fs.writeFileSync("tasks/faith-review-worklist.md", lines.join("\n"));
console.log(`Wrote tasks/faith-review-worklist.md`);
