// Extract Life pillar review worklist:
...
for (const [boardId, tasks] of Object.entries(HEALTH_SEED_TASKS)) {
...
const lines = [];
lines.push("# Life Pillar — Launch-Readiness Review Worklist");
lines.push("");
...
fs.writeFileSync("tasks/life-review-worklist.md", lines.join("\n"));
console.log(`Wrote tasks/life-review-worklist.md`);
